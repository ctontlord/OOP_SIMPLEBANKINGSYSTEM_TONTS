...
public class loginframe extends javax.swing.JFrame {
   ...
   // Prompt the user to enter the username
    String username = JOptionPane.showInputDialog(null, "Enter your username:","Enter Preferred Account Username.",JOptionPane.PLAIN_MESSAGE); 
    if (username == null) {
        return; 
    }
    // Prompt the user to enter the password
    String password = JOptionPane.showInputDialog(null, "Enter your password:","Enter Preferred Account Password.",JOptionPane.PLAIN_MESSAGE);
    if (password == null) {
        return; 
    }
    ...
    if (credentials.containsKey(username)) {
        ...
        JOptionPane.showMessageDialog(null, "Account created successfully!\nYour initial balance is: ₱ 5000","Congratulations",JOptionPane.INFORMATION_MESSAGE);
    }
